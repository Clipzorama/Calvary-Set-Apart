          ...
          <div className="grid gap-10 md:gap-14 lg:grid-cols-2 items-center">
            ...
            <div className="relative mx-auto my-auto">
              <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125" 
                xmlSpace="preserve" className="h-60 w-60 md:h-80 md:w-80 lg:w-100 lg:h-100 xl:w-120 xl:h-120 text-foreground xl:absolute xl:top-1/2 xl:-translate-y-[40%] xl:-translate-x-[40%] ">
