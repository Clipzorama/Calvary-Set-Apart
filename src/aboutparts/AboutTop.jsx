    ...
    return (
        <section id="about" className="w-full px-4 relative min-h-screen pt-45 pb-30">
            ...
            <div className="mx-auto w-full max-w-6xl mt-16 md:mt-24 grid md:grid-cols-2 items-center gap-8 md:gap-12">
                ...
                <h2 className="font-poppins font-semibold text-2xl md:text-5xl leading-tight text-center opacity-0 animate-fade-in-delay-3">
                    A Place to Belong
                </h2>
                <p className="font-poppins mt-4 text-foreground/80 leading-relaxed text-center opacity-0 animate-fade-in-delay-4">
